...
namespace SocialBlog.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CommentId,CommentText,PostId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CommentId,CommentText,PostId")] Comment comment)
        {
            if (ModelState.IsValid)
            {
